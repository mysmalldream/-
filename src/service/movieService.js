...
export default {
  ...
  // 获取电影详细数据
    getMovieDetailData(id){
        const url = `${config.HTTP}${config.SERVER_PATH}:${config.PORT}/getMovieDetailData?id=${id}`
        return new Promise(function (resolve, reject) {
                    ...
                    "directors": [
                        {
                            ...
                            "avatars": {
                                "small": "https://img3.doubanio.com/img/celebrity/small/4286.jpg",
                                "large": "https://img3.doubanio.com/img/celebrity/large/4286.jpg",
                                "medium": "https://img3.doubanio.com/img/celebrity/medium/4286.jpg"
                            },
                            "name": "格雷格·莫托拉",
                            "id": "1274466"
                        }
            ...
            // 真实数据请求
             fetch(url)
                ...
                .then((data) => {
                    console.log('movieservice-->' + data)
                    resolve(data)
                })
                .catch((err)=> {
                    console.log('movieservice-->error')
                    reject(err)
                })
        });
